...
import type { ProductPickerModalProps } from '@/features/stylist/types/product-picker-modal';
          ...
          {filteredProducts.map((p) => {
            ...
            return (
              <div
                ...
                className={`flex gap-3 p-3 rounded-xl border cursor-pointer transition-all ${isSelected
