...
export type PutProductsInput = { name: string; price: number; category: GarmentCategory; garmentType?: string | null; color: string | undefined; colors: { name: string; hex: string; }[]; stock: number; material: string | undefined; description: string | undefined; status: ProductStatus; };
