...
export const STATUS_CONFIG: Record<string, {
  ...
  DELIVERED: { label: 'Đã giao hàng', icon: CheckCircle2, badge: 'bg-blue-50 text-blue-700 border border-blue-200', step: 8 },
  COMPLETED: { label: 'Hoàn thành', icon: CheckCircle2, badge: 'bg-emerald-50 text-emerald-700 border border-emerald-200', step: 9 },
...
export const STEPS = ['Đặt', 'TT', 'Số đo', 'Chốt', 'May', 'QC', 'Giao', 'Ship', 'Đã nhận', 'Hoàn tất'];
