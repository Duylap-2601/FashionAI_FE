...
import { TABS } from '@/features/notifications/constants/notifications-page';
            ...
            {TABS.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`px-4 py-2.5 rounded-full text-body-sm font-medium transition-all flex items-center gap-2 whitespace-nowrap ${isActive
